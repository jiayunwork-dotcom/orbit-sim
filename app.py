...
if page == "📊 轨道要素分析":
    ...
    with tab1:
        ...
        with col_params:
            ...
            sigma1 = st.number_input("位置不确定性 σ₁ (km)", value=0.15, min_value=0.001, step=0.01, key="cr_sigma1")
            
            st.markdown("---")
            st.markdown("#### 物体2（碎片/目标）")
            a2 = st.number_input("半长轴 a₂ (km)", value=7000.02, min_value=6400.0, step=100.0, key="cr_a2")
            ...
            nu2 = st.number_input("真近点角 ν₂ (°)", value=0.001, min_value=0.0, max_value=360.0, step=0.001, format="%.3f", key="cr_nu2")
